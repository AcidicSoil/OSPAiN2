    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2 flex items-center">
          <StorageIcon className="mr-2" /> Knowledge Graph
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          <div className="flex items-center justify-between mb-2">
            ...
            <BubbleChartIcon className="text-blue-600 dark:text-blue-400" />
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          <div className="flex items-center justify-between mb-2">
            ...
            <FolderIcon className="text-green-600 dark:text-green-400" />
          </div>
        ...
        <div className="md:col-span-2 bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          ...
          <div className="text-center py-12 text-gray-600 dark:text-gray-400">
            <BubbleChartIcon
              style={{ fontSize: 48 }}
              className="mb-2 mx-auto text-blue-500 opacity-50"
            />
