...
const TaskTypeDistribution = ({ tasks, }) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        Object.values(Task_1.TaskType).forEach((type) => {
            typeMap.set(type, 0);
        });
        // Count tasks by type
        tasks.forEach((task) => {
        ...
        const colorScale = d3
            .scaleOrdinal()
            .domain(Object.values(Task_1.TaskType))
            .range([
    ...
    return (<div style={{
      ...
      <div style={{
        ...
        {Object.values(Task_1.TaskType).map((type) => (<div key={type} style={{
                display: "flex",
                alignItems: "center",
                marginRight: "12px",
            }}>
            <div style={{
                ...
                height: "12px",
                borderRadius: "2px",
                backgroundColor: type === Task_1.TaskType.MODEL_REQUEST
                    ? "#3b82f6"
...
exports.default = TaskTypeDistribution;
//# sourceMappingURL=TaskTypeDistribution.js.map