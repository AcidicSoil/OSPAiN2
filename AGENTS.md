...
This project is indexed by GitNexus as **OSPAiN2** (3199 symbols, 7017 relationships, 238 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/OSPAiN2/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/OSPAiN2/context` | Codebase overview, check index freshness |
| `gitnexus://repo/OSPAiN2/clusters` | All functional areas |
| `gitnexus://repo/OSPAiN2/processes` | All execution flows |
| `gitnexus://repo/OSPAiN2/process/{name}` | Step-by-step execution trace |
