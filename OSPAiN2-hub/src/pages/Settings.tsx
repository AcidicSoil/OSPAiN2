 ...
 */
const Settings = () => {
  const { settings, updateSettings } = useRateLimit();
  ...
  const removeExcludedTool = (index: number) => {
    const newExcludedTools = [...formState.excludedTools];
  ...
  const handleRealTimeMonitoringChange = (
  ...
  const resetToDefaults = () => {
    if (
      ...
      const defaultSettings: RateLimitSettings = {
        ...
        autoBypass: true,
        bypassMethod: "session-rotation" as const,
        monitorInterval: 30,
    ...
    <div className="p-6">
      ...
      <div className="flex mb-6">
        <div className="flex space-x-2">
          ...
          >
            <SpeedIcon className="mr-2" fontSize="small" />
            Rate Limits
          </button>
      ...
      {activeTab === "rate-limits" && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold mb-4 flex items-center">
            <SpeedIcon className="mr-2" /> Rate Limit Settings
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      max="95"
                      step="5"
                      value={formState.notificationThreshold}
                      onChange={handleChange}
                      className="w-full"
                    />
                ...
                <div className="mb-4">
                  <div className="flex items-center mb-1">
                    <input
                      ...
                      checked={formState.realTimeMonitoring}
                      onChange={handleRealTimeMonitoringChange}
                      className="mr-2 h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <label
                      htmlFor="realTimeMonitoring"
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      max="60"
                      step="1"
                      value={formState.monitorInterval}
                      onChange={handleChange}
                      className="w-full"
                    />
                    <span className="ml-2 text-sm font-medium">
              ...
              <div>
                ...
                {formState.excludedTools.map((tool, index) => (
                  <div key={index} className="flex items-center mb-2">
                    <input
                      type="text"
                      value={tool}
                      onChange={(e) => handleArrayChange(e, index)}
                      className="flex-1 rounded-md border border-gray-300 shadow-sm p-2 text-sm
                                dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      placeholder="Enter tool name"
                    />
                    <button
                      type="button"
                      onClick={() => removeExcludedTool(index)}
                ...
                <button
                  type="button"
                  onClick={addExcludedTool}
                  className="text-sm bg-gray-100 text-gray-700 px-3 py-1 rounded-md dark:bg-gray-700 dark:text-gray-300"
                >
                  + Add Tool
                </button>
              </div>
