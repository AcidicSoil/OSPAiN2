import { EnhancedContextManager } from "../context/EnhancedContextManager";
...
describe("Token Context Management System", () => {
  ...
  describe("EnhancedContextManager", () => {
    it("should optimize context within token limits", async () => {
      ...
      const mode = DevelopmentMode.Engineering;
    ...
    it("should handle different development modes appropriately", async () => {
      ...
      const modes = Object.values(DevelopmentMode);
  ...
  describe("KnowledgeGraph", () => {
    ...
    it("should prioritize elements correctly", async () => {
      ...
      const prioritizedContext = await knowledgeGraph.prioritizeElements(
        context
      );
      expect(prioritizedContext.indexOf("mainFunction")).toBeLessThan(
        prioritizedContext.indexOf("utilityFunction")
      );
    });
  });
