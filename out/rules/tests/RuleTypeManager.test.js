...
const RuleTypeManager_1 = require("../manager/RuleTypeManager");
...
describe('RuleTypeManager', () => {
    let manager;
    beforeEach(() => {
        manager = new RuleTypeManager_1.RuleTypeManager();
    });
    describe('updateRuleType', () => {
        it('should update a rule type successfully', async () => {
            ...
            await expect(manager.updateRuleType('/rules/core/test-rule.mdc', types_1.RuleType.AUTO_APPLIED)).resolves.not.toThrow();
        });
        it('should throw an error for an invalid path', async () => {
            ...
            await expect(manager.updateRuleType('', types_1.RuleType.AUTO_APPLIED)).resolves.not.toThrow();
        });
    });
            ...
            const updates = [
                {
                    ...
                    newType: types_1.RuleType.AUTO_APPLIED,
                    reason: 'Test update'
                },
                {
                    path: '/rules/conditional/rule2.mdc',
                    currentType: types_1.RuleType.AUTO_APPLIED,
                    newType: types_1.RuleType.CONDITIONAL,
                    reason: 'Test update'
                }
            ];
    ...
    describe('monitorPerformance', () => {
        it('should return performance metrics', async () => {
            ...
            await manager.updateRuleType('/rules/core/test-rule.mdc', types_1.RuleType.AUTO_APPLIED);
...
//# sourceMappingURL=RuleTypeManager.test.js.map