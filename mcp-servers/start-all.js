...
const servers = [
    {
        ...
        script: (0, path_1.join)(__dirname, "prompt-engineering", "prompt-engineering-server.js"),
    ...
    },
    {
        ...
        script: (0, path_1.join)(__dirname, "docker-integration", "docker-integration-server.js"),
        port: parseInt(process.env.DOCKER_INTEGRATION_PORT || "3002", 10),
        env: {
            ALLOWED_DOCKER_COMMANDS: process.env.ALLOWED_DOCKER_COMMANDS || "ls,ps,exec,logs,inspect,stats",
        },
    },
    {
        name: "Mouse Automation",
        script: (0, path_1.join)(__dirname, "mouse-automation", "mouse-automation-server.js"),
    ...
    },
    {
        ...
        script: process.env.KNOWLEDGE_GRAPH_SCRIPT ||
            (0, path_1.join)(__dirname, "../mcp-knowledge-graph/dist/index.js"),
        port: parseInt(process.env.KNOWLEDGE_GRAPH_PORT || "3004", 10),
        env: {
            MEMORY_PATH: process.env.KNOWLEDGE_GRAPH_MEMORY_PATH ||
                (0, path_1.join)(process.cwd(), "data/memory.jsonl"),
...
function startServer(config) {
    ...
    const serverProcess = (0, child_process_1.spawn)("node", [config.script], {
        env,
        stdio: "pipe",
        detached: false,
    });
    ...
    serverProcess.on("exit", (code, signal) => {
        console.log(`[${config.name}] Server exited with code ${code} (signal: ${signal})`);
...
// Start servers
startAllServers();
//# sourceMappingURL=start-all.js.map