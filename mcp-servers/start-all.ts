...
const servers: ServerConfig[] = [
    {
        ...
        script: join(__dirname, 'prompt-engineering', 'prompt-engineering-server.js'),
    ...
    },
    {
        ...
        script: join(__dirname, 'docker-integration', 'docker-integration-server.js'),
    ...
    {
        name: 'Titan Memory',
        script: join(__dirname, 'titan-memory', 'titan-memory-server.js'),
        port: parseInt(process.env.TITAN_MEMORY_PORT || '3004', 10),
        env: {
            TITAN_MEMORY_DB_PATH: process.env.TITAN_MEMORY_DB_PATH || ''
        }
    }
];
